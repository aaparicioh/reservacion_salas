class AgendasController < ApplicationController
    ...
    respond_to do |format|
      ...
      format.pdf do
        ...
        send_data pdf.render,
          filename: "calendarios.pdf", type: 'application/pdf', disposition: 'inline'
      end
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @agenda.save
        format.html { redirect_to agendas_path(format: 'pdf'), :method => :get }
  ...
  private
    ...
    def agenda_params
      params.require(:agenda).permit(:fecha)
    end
end
