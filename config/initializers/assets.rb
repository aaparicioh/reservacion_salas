...
Rails.application.config.assets.precompile += %w( cal_global.js )
Rails.application.config.assets.precompile += %w( cal_salaVideoconferencias.js )
Rails.application.config.assets.precompile += %w( valoresIniciales.js )
Rails.application.config.assets.precompile += %w( validacionValoresIniciales.js )
